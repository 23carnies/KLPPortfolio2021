...
import { Flex, box_shadow2, white, black, below } from '../components/utilities';
import { LgGithub, LgLinkedIn, LgPDF } from '../components/utilities/icons';
    ...
    return ( 
        <Foot>
          <FootDiv>
            ...
            <a rel="noreferrer" target="_blank" href="/posts/karenLobinPerkinsRes.pdf" alt="link to Karen's resume in pdf format, opens new window"><LgPDF /></a>
